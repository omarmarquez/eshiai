  ...
  var $options;
	...
	function DoDirectPayment($paymentInfo = array () ) {
		...
		*/
		...
		$nvpstr = "&PAYMENTACTION=Sale&IPADDRESS=$ip&AMT=$amount&CREDITCARDTYPE=$creditCardType&ACCT=$creditCardNumber&EXPDATE=" . $padDateMonth . $expDateYear . "&CVV2=$cvv2Number"
		."&FIRSTNAME=$firstName&LASTNAME=$lastName&STREET=$address1&STREET2=$address2&CITY=$city&STATE=$state"
		...
		*/
			return $resArray; //Contains 'TRANSACTIONID,AMT,AVSCODE,CVV2MATCH, Or Error Codes'
			}
	...
	function hash_call($methodName, $nvpStr) {
		...
		$API_UserName = $this->options['paypal_username'];
		$API_Password = $this->options['paypal_password'];
		$API_Signature = $this->options['paypal_signature'];
